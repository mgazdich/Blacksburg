...
#ifdef DEBUG
    NSLog(@"Website URL received in the Website View Controller = %@", @"http://www.blacksburg.va.us/Index.aspx?page=214");
#endif
    
    // Asks the UIWebView object to display the web page at URL = websiteURL
    [self.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://www.blacksburg.va.us/Index.aspx?page=214"]]];
    [self.label setTitle: @"Hospitals"];
