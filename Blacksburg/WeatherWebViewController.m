...
#ifdef DEBUG
    NSLog(@"Website URL received in the Website View Controller = %@", @" http://i.wund.com/cgi-bin/findweather/getForecast?brand=iphone&query=24060");
#endif
    
    // Asks the UIWebView object to display the web page at URL = websiteURL
    [self.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://i.wund.com/cgi-bin/findweather/getForecast?brand=iphone&query=24060"]]];
    [self.label setTitle: @"Weather"];
